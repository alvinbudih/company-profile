...
<html lang="en">
    <head>
        ...
        <link
            rel="stylesheet"
            href="{{ asset('assets/css/font-awesome/css/font-awesome.css') }}"
            type="text/css"
        />
        <link rel="stylesheet" href="{{ asset('assets/css/style.css') }}" type="text/css" />
        <link
            rel="stylesheet"
            href="{{ asset('assets/css/no-ui-slider/jquery.nouislider.css') }}"
            type="text/css"
        />
    ...
    <body>
                    ...
                    <div class="tp-banner">
                        <ul>
                            ...
                            <li
                                ...
                                data-thumb="{{ asset('assets/img/backgrounds/bg.jpg') }}"
                                data-delay="10000"
                                data-saveperformance="on"
                                data-title="We Are Visual"
                            >
                                <img
                                    src="{{ asset('assets/img/backgrounds/bg.jpg') }}"
                                    alt="slidebg1"
                                ...
                                <div
                                    ...
                                    "
                                >
                                    <h2 class="home-heading op-1">
                                        We Are Visual
                                    </h2>
                                </div>
                                <!-- Home Subheading -->
                                <div
                                    class="tp-caption home-subheading sft"
                                    data-x="center"
                                    data-y="360"
                                    data-speed="1200"
                                    data-start="1350"
                                ...
                                >
                                    <div class="op-1">
                                        Beautiful & Elegant One page Parallax
                                        Template
                                    </div>
                                </div>
                                <!-- Home Button -->
                                <div
                                    class="tp-caption home-button sft fadeout"
                                    data-x="center"
                                    data-y="400"
                                    data-speed="1200"
                                    data-start="1550"
                            ...
                            <li
                                ...
                                data-slotamount="7"
                                data-masterspeed="2000"
                                data-thumb="{{ asset('assets/img/backgrounds/bg-1.jpg') }}"
                                data-delay="10000"
                                data-saveperformance="on"
                                data-title="Digital Agency"
                            >
                                <img
                                    src="{{ asset('assets/img/backgrounds/bg-1.jpg') }}"
                                    alt="slidebg1"
                                    data-bgposition="center top"
                                    data-bgfit="cover"
                                    data-bgrepeat="no-repeat"
                                ...
                                <div
                                    ...
                                    "
                                >
                                    <h2 class="home-heading op-2">
                                        A Digital Design Agency
                                    </h2>
                                </div>
                                <!-- Home Subheading -->
                                <div
                                    class="tp-caption home-subheading sft fadeout"
                                    data-x="center"
                                    data-y="360"
                                    data-speed="1200"
                                    data-start="1350"
                            ...
                            <li
                                ...
                                data-slotamount="7"
                                data-masterspeed="2000"
                                data-thumb="{{ asset('assets/img/backgrounds/bg-2.jpg') }}"
                                data-delay="10000"
                                data-saveperformance="on"
                                data-title="Creative Coders"
                            >
                                <img
                                    src="{{ asset('assets/img/backgrounds/bg-2.jpg') }}"
                                    alt="slidebg1"
                                    data-bgposition="center top"
                                    data-bgfit="cover"
                                    data-bgrepeat="no-repeat"
                    ...
                    <div class="home-bottom">
                        <div class="container text-center">
                            <div class="move bounce">
                                <a
                                    href="#features"
                                    class="ion-ios-arrow-down btn-scroll"
                                >
                                </a>
                            </div>
                        </div>
        ...
        <div class="site-wrapper content">
            ...
            <section id="features">
                <div class="container">
                    <div class="col-md-12 text-center wow fadeInUp">
                        ...
                        <p class="subheading">
                            We are a small<span class="highlight">
                                creative team</span
                    ...
                    <div class="row features-row wow fadeInUp">
                        <div class="col-md-4 col-sm-12 feature-column">
                            <div class="feature-icon">
                                <i
                                    class="icon-eyeglasses size-2x highlight"
                                ></i>
                            ...
                            <div class="feature-info">
                                ...
                                <p class="feature-description">
                                    Vivamus molestie phasellus enim sed orci eu
                                    pharetra. Donec posuere nunc vitae tortor
                                    sagittis feugiat in non massa.
                                </p>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12 feature-column">
                    ...
                    <div class="row">
                        <div class="col-md-6 text-left about-text">
                            ...
                            <p class="wow fadeInUp">
                                Fusce faucibus tincidunt nulla, tincidunt
                                sagittis magna venenatis quis. Proin commodo eu
                                ipsum eu suscipit. In dapibus arcu sit amet
                                imperdiet posuere. Praesent condimentum nulla at
                                mauris ornare, eget consequat felis euismod.
                                Praesent condimentum nulla at mauris ornare.
                            </p>
                            <p class="wow fadeInUp">
                                <button
                                    type="button"
                ...
                <div class="container">
                    <div class="col-md-12 text-center white wow fadeInUp">
                        ...
                        <p class="subheading">
                            ...
                            <span class="highlight">big ideas</span> and
                            challenges.
                        </p>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-3 team-member">
                            <div class="effect effects wow fadeInUp">
                                <div class="img">
                                    <img
                                        src="{{ asset('assets/img/team/team-1.jpg') }}"
                            ...
                            <div class="member-info wow fadeInUp">
                                ...
                                <p>
                                    Vivamus motestues phasellus enim sed orci eu
                                    pharetra.
                                </p>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3 team-member">
                            <div class="effect effects wow fadeInUp">
                                <div class="img">
                                    <img
                                        src="{{ asset('assets/img/team/team-2.jpg') }}"
                                        class="img-responsive"
                                        alt=""
                                    />
                                    <div class="overlay">
                        ...
                        <div class="col-md-3 col-sm-3 team-member">
                            <div class="effect effects wow fadeInUp">
                                <div class="img">
                                    <img
                                        src="{{ asset('assets/img/team/team-3.jpg') }}"
                                        class="img-responsive"
                                        alt=""
                                    />
                                    <div class="overlay">
                        ...
                        <div class="col-md-3 col-sm-3 team-member">
                            <div class="effect effects wow fadeInUp">
                                <div class="img">
                                    <img
                                        src="{{ asset('assets/img/team/team-4.jpg') }}"
                                        class="img-responsive"
                                        alt=""
                                    />
                                    <div class="overlay">
                        ...
                        <div class="col-lg-12 wow fadeInUp" style="z-index: 3">
                            <div id="quote-slider" class="owl-carousel">
                                <div>
                                    <blockquote>
                                        <i
                                            class="icon-left ion-quote ion-2x highlight"
                                        ></i>
                                        <span>
                                        ...
                                        <i
                                            class="icon-right ion-quote ion-2x highlight"
                                        ></i>
                                    </blockquote>
                                    <h4 class="quote-author highlight">
                                        Visual Team
                                    </h4>
                                </div>
                                <div>
                                    <blockquote>
                                        ...
                                        ></i>
                                        <span>
                                            A Perfect Design is made with
                                            Passion, Dedication,<br />
                                ...
                                <div>
                                    <blockquote>
                                        ...
                                        ></i>
                                        <span>
                                            What separates design from art is
                                            that design is<br />
                ...
                <div class="container-fluid">
                    <div class="col-md-12 text-center">
                        ...
                        <p class="subheading wow fadeInUp">
                            ...
                            <span class="highlight">transform brands</span>.
                        </p>
                    </div>
                    <div
                        id="filters-container-fullwidth"
                    ...
                    <div
                        id="grid-container-fullwidth"
                        class="cbp-l-grid-fullScreen"
                    >
                        <ul>
                                ...
                                <div class="img">
                                    ...
                                    <div class="overlay">
                                        <ul class="expand">
                                            <li class="cbp-l-icon">
                                                <a
                                                    href="{{ asset('assets/img/portfolio/fullsize/1.jpg') }}"
                                                    class="cbp-lightbox"
                                            ...
                                            <li class="cbp-l-icon">
                                                <a
                                                    href="assets/projects/project1.html"
                                                    class="cbp-singlePage"
                                                >
                                                    <i class="icon-link"></i>
                                                </a>
                                            </li>
                                            <li class="cbp-l-caption-title">
                                                Future Trend
                                            </li>
                                            <li class="cbp-l-caption-desc">
                                                by Visual Design
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="img">
                                    ...
                                    <div class="overlay">
                                        <ul class="expand">
                                            <li class="cbp-l-icon">
                                                <a
                                                    href="{{ asset('assets/img/portfolio/fullsize/2.jpg') }}"
                                                    class="cbp-lightbox"
                                                    data-title="Dashboard<br>by Visual"
                                                >
                                                    <i
                                            ...
                                            <li class="cbp-l-icon">
                                                <a
                                                    href="assets/projects/project2.html"
                                                    class="cbp-singlePage"
                                                >
                                                    <i class="icon-link"></i>
                                                </a>
                                ...
                                <div class="img">
                                    ...
                                    <div class="overlay">
                                        <ul class="expand">
                                            <li class="cbp-l-icon">
                                                <a
                                                    href="{{ asset('assets/img/portfolio/fullsize/3.jpg') }}"
                                                    class="cbp-lightbox"
                                                    data-title="Dashboard<br>by Visual"
                                                >
                                                    <i
                                ...
                                <div class="img">
                                    ...
                                    <div class="overlay">
                                        <ul class="expand">
                                            <li class="cbp-l-icon">
                                                <a
                                                    href="{{ asset('assets/img/portfolio/fullsize/5.jpg') }}"
                                                    class="cbp-lightbox"
                                                    data-title="Dashboard<br>by Visual"
                                                >
                                                    <i
                                ...
                                <div class="img">
                                    ...
                                    <div class="overlay">
                                        <ul class="expand">
                                            <li class="cbp-l-icon">
                                                <a
                                                    href="{{ asset('assets/img/portfolio/fullsize/7.jpg') }}"
                                                    class="cbp-lightbox"
                                                    data-title="Dashboard<br>by Visual"
                                                >
                                                    <i
                                ...
                                <div class="img">
                                    ...
                                    <div class="overlay">
                                        <ul class="expand">
                                            <li class="cbp-l-icon">
                                                <a
                                                    href="{{ asset('assets/img/portfolio/fullsize/8.jpg') }}"
                                                    class="cbp-lightbox"
                                                    data-title="Dashboard<br>by Visual"
                                                >
                                                    <i
                            ...
                            <li
                                class="cbp-item effect effects web-design graphic"
                            >
                                <div class="img">
                                    <img
                                        src="{{ asset('assets/img/portfolio/10.jpg') }}"
                                        class="img-responsive"
                                        alt=""
                                    />
                                    <div class="overlay">
                                        <ul class="expand">
                                            <li class="cbp-l-icon">
                                                <a
                                                    href="{{ asset('assets/img/portfolio/fullsize/10.jpg') }}"
                                                    class="cbp-lightbox"
                                                    data-title="Dashboard<br>by Visual"
                                                >
                                                    <i
                            ...
                            <li class="cbp-item effect effects graphic logo">
                                <div class="img">
                                    <img
                                        src="{{ asset('assets/img/portfolio/11.jpg') }}"
                                        class="img-responsive"
                                        alt=""
                                    />
                                    <div class="overlay">
                                        <ul class="expand">
                                            <li class="cbp-l-icon">
                                                <a
                                                    href="{{ asset('assets/img/portfolio/fullsize/11.jpg') }}"
                                                    class="cbp-lightbox"
                                                    data-title="Dashboard<br>by Visual"
                                                >
                                                    <i
                            ...
                            <li class="cbp-item effect effects graphic logo">
                                <div class="img">
                                    <img
                                        src="{{ asset('assets/img/portfolio/12.jpg') }}"
                                        class="img-responsive"
                                        alt=""
                                    />
                                    <div class="overlay">
                                        <ul class="expand">
                                            <li class="cbp-l-icon">
                                                <a
                                                    href="{{ asset('assets/img/portfolio/fullsize/12.jpg') }}"
                                                    class="cbp-lightbox"
                                                    data-title="Dashboard<br>by Visual"
                                                >
                                                    <i
                    ...
                    <div class="cbp-l-loadMore-button">
                        <a
                            href="projects/loadMore.html"
                            class="cbp-l-loadMore-button-link wow fadeInUp"
                        >
                            SHOW ME MORE
                        </a>
            ...
            <section id="services" class="parallax-section-9">
                <div class="container">
                    <div class="col-md-12 text-center">
                        ...
                        <p class="subheading wow fadeInUp">
                            We use
                            <span class="highlight">our expertise</span> to
                            extend your brand.
                        </p>
                    </div>
                    <div class="row features-row wow fadeInUp">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <p class="subheading wow fadeInUp">
                                Meet our clients, some of the most well known
                                companies.
                            </p>
                        </div>
                        <div class="clients">
                            <div id="client-slider" class="owl-carousel">
                                <div class="item">
                                    <img
                                        src="{{ asset('assets/img/clients/logo-1-dark.png') }}"
                                        alt=""
                                    />
                                </div>
                                <div class="item">
                                    <img
                                        src="{{ asset('assets/img/clients/logo-2-dark.png') }}"
                                        alt=""
                                    />
                                </div>
                                <div class="item">
                                    <img
                                        src="{{ asset('assets/img/clients/logo-3-dark.png') }}"
                                        alt=""
                                    />
                                </div>
                                <div class="item">
                                    <img
                                        src="{{ asset('assets/img/clients/logo-4-dark.png') }}"
                                        alt=""
                                    />
                                </div>
                                <div class="item">
                                    <img
                                        src="{{ asset('assets/img/clients/logo-5-dark.png') }}"
                                        alt=""
                                    />
                                </div>
                                <div class="item">
                                    <img
                                        src="{{ asset('assets/img/clients/logo-6-dark.png') }}"
                                        alt=""
                                    />
                                </div>
                                <div class="item">
                                    <img
                                        src="{{ asset('assets/img/clients/logo-7-dark.png') }}"
                                        alt=""
                                    />
                                </div>
                                <div class="item">
                                    <img
                                        src="{{ asset('assets/img/clients/logo-8-dark.png') }}"
                                        alt=""
                                    />
                                </div>
                                <div class="item">
                                    <img
                                        src="{{ asset('assets/img/clients/logo-9-dark.png') }}"
                                        alt=""
                                    />
                                </div>
                                <div class="item">
                                    <img
                                        src="{{ asset('assets/img/clients/logo-10-dark.png') }}"
                                        alt=""
                                    />
                                </div>
                                <div class="item">
                                    <img
                                        src="{{ asset('assets/img/clients/logo-11-dark.png') }}"
                                        alt=""
                                    />
                                </div>
                            </div>
                            ...
                            <div class="container">
                                <div class="col-md-3 col-sm-6">
                                    <div class="planbox">
                                        ...
                                        <ul>
                                            <li>
                                                <strong>Unlimited</strong> Web
                                                Space
                                            </li>
                                            <li>
                                                <strong>FREE</strong> Site
                                                Building Tools
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <strong>FREE</strong> Marketing
                                                &amp; SEO Tools
                                            </li>
                                            <li>
                                                <strong>99.9%</strong> Service
                                                Uptime
                                            </li>
                                            <li class="last">
                                                <strong>30 Day</strong> Money
                                                Back Guarantee
                                            </li>
                                        </ul>
                                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <p class="wow fadeInUp">
                                Vivamus a placerat ante. Duis vulputate nibh sit
                                amet augue vehicula, mattis ni<br />
                                viverra purus tristique. Proin commodo eu ipsum.
                            </p>
                            <a
                                href="#contact"
                                class="btn btn-primary btn-scroll"
            ...
            <section id="testimonials" class="parallax-section-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h3 class="section-title white wow fadeInUp">
                                What clients say.
                            </h3>
                            ...
                            <div id="owl-testimonials" class="owl-carousel">
                                <div>
                                    <div class="testimonial">
                                        ...
                                        ></i>
                                        <span>
                                            This guys are amazing! They were so
                                            quick to respond and let me tell
                                            you... they are all knowing!<br />
                                            I highly recommend their themes!
                                            They are all about making their
                                            clients happy.
                                        </span>
                                        <i
                                            class="icon-right ion-quote ion-2x highlight"
                                ...
                                <div>
                                    <div class="testimonial">
                                        ...
                                        <span>
                                            ...
                                            template I ever bought! Easy to
                                            edit, nicely coded and I highly
                                            recommend it.<br />
                                            It's wonderful design and also very
                                            fast and excelent support.
                                        </span>
                                        <i
                                            class="icon-right ion-quote ion-2x highlight"
                                        ></i>
                                ...
                                <div>
                                    <div class="testimonial">
                                        ...
                                        ></i>
                                        <span>
                                            Visual is well documented and well
                                            coded, but the best of all is the
                                            friendly and quick support behind
                                            it.<br />
                                            Visual Design did a great and
                                            dedicated job. Thank you for this
                                            awesome theme!
                                        </span>
                                        <i
                                            class="icon-right ion-quote ion-2x highlight"
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-7 wow fadeInUp">
                            ...
                            <form
                                method="post"
                                action="php/contact-form.php.htm"
                                name="contactform"
                                id="contactform"
                            >
                                <fieldset>
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <ul class="social-icons subheading">
                                    ...
                                    <li>
                                        <a href="#">
                                            <i
                                                class="icon ion-social-googleplus"
                                            ></i>
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="#">
                                            <i
                                                class="icon ion-social-pinterest"
                                            ></i>
                                        </a>
                                    </li>
                                    <li>
        ...
        <script
            type="text/javascript"
            src="{{ asset('assets/js/plugins/moderniz.min.js') }}"
        ></script>
        <script
            type="text/javascript"
            src="{{ asset('assets/js/plugins/smoothscroll.min.js') }}"
        ></script>
        <script
            type="text/javascript"
            src="{{ asset('assets/js/no-ui-slider/jquery.nouislider.all.min.js') }}"
        ></script>
        <script
            type="text/javascript"
            src="{{ asset('assets/js/plugins/revslider.min.js') }}"
        ></script>
        <script
            type="text/javascript"
            src="{{ asset('assets/js/plugins/waypoints.min.js') }}"
        ></script>
        <script
            type="text/javascript"
            src="{{ asset('assets/js/plugins/parallax.min.js') }}"
        ></script>
        <script
            type="text/javascript"
            src="{{ asset('assets/js/plugins/easign1.3.min.js') }}"
        ></script>
        <script
            type="text/javascript"
            src="{{ asset('assets/js/plugins/cubeportfolio.min.js') }}"
        ></script>
        <script
            type="text/javascript"
            src="{{ asset('assets/js/plugins/owlcarousel.min.js') }}"
        ></script>
        <script type="text/javascript" src="{{ asset('assets/js/plugins/tweetie.min.js') }}"></script>
        <script
            type="text/javascript"
            src="http://maps.googleapis.com/maps/api/js"
        ></script>
        <script type="text/javascript" src="{{ asset('assets/js/plugins/gmap3.min.js') }}"></script>
        <script type="text/javascript" src="{{ asset('assets/js/plugins/wow.min.js') }}"></script>
        <script
            type="text/javascript"
            src="{{ asset('assets/js/plugins/counterup.min.js') }}"
        ></script>
